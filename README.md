...
<p><strong>TagIE is a tool for digital process automation (RPA). It's working like <a href="https://github.com/kelaberetiv/TagUI" rel="nofollow">TagUI</a>, but in user-friendly language AutoHotKey. It is maintained by Arnaud DEGARDIN (<a href="https://www.pc-dream.it" rel="nofollow">PC-Dream.it</a>), an Italian Developer. To start, check out above tutorial, slides, or video.</strong></p>
